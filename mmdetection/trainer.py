...
def main():
    ...
    # 설정 생성
    max_epochs = 30     # 에폭 설정
    cfg, model_name, output_dir = create_config('faster_rcnn_x101', max_epochs=max_epochs)  # 모델 Config에 epoch 넘김
    ...
    wandb.init(
        project="faster_rcnn_x101_64x4d_fpn_mstrain_3x_coco", 
        dir=experiment_dir,
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep=sweep_configuration, project='faster_rcnn_x101_64x4d_fpn_mstrain_3x_coco')
